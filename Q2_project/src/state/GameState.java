...
public final class GameState extends Table {
  ...
  public state.KeyState keys(int j) { return keys(new state.KeyState(), j); }
  public state.KeyState keys(state.KeyState obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int keysLength() { int o = __offset(4); return o != 0 ? __vector_len(o) : 0; }
  public state.KeyState.Vector keysVector() { return keysVector(new state.KeyState.Vector()); }
  public state.KeyState.Vector keysVector(state.KeyState.Vector obj) { int o = __offset(4); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public state.PlayerState player() { return player(new state.PlayerState()); }
  public state.PlayerState player(state.PlayerState obj) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  public state.EnemyState enemies(int j) { return enemies(new state.EnemyState(), j); }
  public state.EnemyState enemies(state.EnemyState obj, int j) { int o = __offset(8); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int enemiesLength() { int o = __offset(8); return o != 0 ? __vector_len(o) : 0; }
  public state.EnemyState.Vector enemiesVector() { return enemiesVector(new state.EnemyState.Vector()); }
  public state.EnemyState.Vector enemiesVector(state.EnemyState.Vector obj) { int o = __offset(8); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
